        ...
        return (
            <View style={styles.container}>
                <View style={styles.image_container}>
                    ...
                    <Image style={styles.configs} source={{uri: 'https://cdn-icons-png.flaticon.com/512/45/45493.png'}}/>
                </View>

                <View style={styles.sub_container}>
                    <View style={styles.firstbutton}>
                        <TouchableOpacity style={styles.button} onPress={() => this.props.navigation.navigate('Infos')} >
                            <Text style={styles.buttonText}>Coletas disponiveis</Text>
                        </TouchableOpacity>
                    </View>

                    <View style={styles.firstbutton}>
                        <TouchableOpacity style={styles.button} >
                            <Text style={styles.buttonText}>Embarques disponiveis</Text>
                        </TouchableOpacity>
                    </View>

                    <View style={styles.firstbutton}>
                        <TouchableOpacity style={styles.button} >
                            <Text style={styles.buttonText}>Desembarques disponiveis</Text>
                        </TouchableOpacity>
                    </View>

                    <View style={styles.firstbutton}>
                        <TouchableOpacity style={styles.button} >
                            <Text style={styles.buttonText}>Entregas disponiveis</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
