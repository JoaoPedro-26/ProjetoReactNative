            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.sub_container}>
                    <View style={styles.title}>
                        <Text style={styles.titleText}>Lançamento da coleta</Text>
                    </View>
                    ...
                    <View style={styles.infos_sub}>
                        <TextInput style={styles.observation} placeholder="Observações">
                    ...
                    <View style={styles.butons_footer}>
                        <TouchableOpacity style={styles.button} title="Ocorrência">
                            <Text style={styles.occorencia}>Ocorrencia</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.button} title="Finalizar" >
                            <Text style={styles.finalizar}>Observação</Text>
                        </TouchableOpacity>
